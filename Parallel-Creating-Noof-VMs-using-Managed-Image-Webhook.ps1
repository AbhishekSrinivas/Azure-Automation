workflow Parallel-Creating-Noof-VMs-using-Managed-Image-Webhook
{
...
Param
    ...
    $NewVM = ConvertFrom-Json -InputObject $WebhookBody

    $NewVMName = $NewVM.NewVMName
    $VMLocation = $NewVM.VMLocation
    $VMSize = $NewVM.VMSize
    $OSProfile = $NewVM.OSProfile
    $SourceImageRGName = $NewVM.SourceImageRGName
    $SourceImageName = $NewVM.SourceImageName
    $VNet_AddPrefix = $NewVM.VNet_AddPrefix
    $Subnet_AddPrefix = $NewVM.Subnet_AddPrefix
    $AdminUserName = $NewVM.AdminUserName
    $AdminPassword = $NewVM.AdminPassword
    $NoofVMs = $NewVM.NoofVMs
    $DataDSKSize = $NewVM.DataDSKSize  
